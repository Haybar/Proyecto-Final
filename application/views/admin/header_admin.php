...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?php echo base_url(); ?>assets/index.html">Vali</a>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-list"></i></i><span class="app-menu__label">Atractivo Turistico</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="<?=base_url('admin/parque')?>"><i class="icon fa fa-tree"></i> Parques </a></li>
          </ul>
        </li>
    ...
    <!-- <div class="app-title">
      <div class="bs-component">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a class="nav-link"  href="<?php echo base_url(); ?>admin/">REGISTRAR USUARIO</a></li>                 
                <li class="nav-item"><a class="nav-link active"  href="<?php echo base_url(); ?>admin/usuario">LISTA DE USUARIO</a></li>                 
...
<!-- 
        ...
        <li><a href="#">MODO ADMINISTRADR</a></li>
        <li><a href="<?=base_url()?>home/selectCrud">LISTA DE USUARIOS</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
      <li><a href="<?=base_url('login/logout')?>"><i class="fa fa-users"></i>logout<span></span></a></li> -->
