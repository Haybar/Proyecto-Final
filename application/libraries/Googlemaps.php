...
class Googlemaps {
	...
	// var $apiKey						= 'AIzaSyD125uBHBKFeKckhBDZn4_YBQTWYqzKBpA'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	var $apiKey						= 'AIzaSyCP3eTt6XMGq757Iu0ZBK-eEeEAEQZRGJ4'; 					// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $map_height					= "290px";					// The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
